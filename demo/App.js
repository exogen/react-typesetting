            ...
            <section>
              ...
              <p>
                <PreventWidows>
                  ...
                  avoid wrapping. By default, adjustments are made to{" "}
                  <code>word-spacing</code>, <code>letter-spacing</code>, and{" "}
                  <code>font-size</code> (preferentially in that order).
                </PreventWidows>
              </p>
              <p>
                <PreventWidows>
            ...
            <section>
              ...
              <p>
                <PreventWidows>
                  ...
                  too much whitespace between the paragraph and what follows,
                  and can be distracting. It is generally preferable to find a
                  way to either remove the extra line (<em>a la</em>{" "}
                  <code>TightenText</code>) or ensure that it is longer. If
              ...
              <p>
                <PreventWidows>
                  Many web typesetting helpers implement this in a naïve way
                  – for example, by always joining the last word with a{" "}
                  <a
