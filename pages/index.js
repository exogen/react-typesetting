          ...
          >
            <MainContent>
              ...
              <section>
                ...
                <Justify>
                  <PreventWidows>
                    ...
                    having fewer lines of text over having completely rigid
                    visual tightness.
                  </PreventWidows>
                </Justify>
                <Justify>
                  <PreventWidows>
                    When a line is just slightly too long for the available
                    space, the text will be set tighter by a barely perceptible
                    amount to avoid wrapping. By default, adjustments are made
                    to word spacing, letter spacing, and font size
                    (preferentially in that order).
                  </PreventWidows>
                </Justify>
                <Justify>
                  <PreventWidows>
                    Try dragging to adjust the available space for this line
                    from a cocktail recipe:
                  </PreventWidows>
                </Justify>

                <ReflowResizable initialWidth={320}>
                  {reflowKey => (
                    <TightenText preset="noShrink" reflowKey={reflowKey}>
              ...
              <section>
                ...
                <Justify>
                  <PreventWidows>
                    Although the terminology varies, “widows” often refer to
                    very short lines of text at the end of paragraphs. This
                    tends to be undesirable during typesetting, as it gives the
                    appearance of too much whitespace between the paragraph and
                    any elements that follow, and can be distracting. It is
                    generally preferable to find a way to either remove the
                    extra line (<em>a la</em> <code>TightenText</code>) or make
                    it longer. If possible, you can even just opt to reword your
                    writing.
                  </PreventWidows>
                </Justify>
                ...
                <Justify>
                  <PreventWidows>
                    Many <abbr>HTML</abbr> typesetting helpers implement this in
                    a naïve way – for example, by always joining the last word
                    with a{" "}
                    <a
                    ...
                    long the last line actually is. Try the naïve approach to
                    see how it fails to achieve the desired wrapping:
                  </PreventWidows>
                </Justify>
                ...
                <Justify>
                  <PreventWidows>
                    ...
                    including percentages, pixels, and ems. The default minimum
                    is 15% of the available width.
                  </PreventWidows>
                </Justify>
                ...
                <Justify>
                  <PreventWidows>
                    ...
                    supplied that highlights the inserted spaces for
              ...
              <Justify>
                <PreventWidows>
                  The current strategy works especially well with justified
                  text, since there is no rag on the preceding line to worry
                  about:
                </PreventWidows>
              </Justify>
              ...
              <ReflowResizable initialWidth={600}>
                {reflowKey => (
                  <p
                    style={{ fontSize: `${15 / 16}rem`, textAlign: "justify" }}
                  >
                    <PreventWidows
                      nbspChar={<VisibleSpace />}
                      reflowKey={reflowKey}
              ...
              <section>
                ...
                <Justify>
                  <PreventWidows>
                    ...
                    enough room, and otherwise the text will inherit its
                    alignment as normal. Here is the same paragraph as above,
                    but using conditional justification. Try making it wider:
                  </PreventWidows>
                </Justify>
              ...
              <section>
                ...
                <Justify>
                  <PreventWidows>
                    ...
                    sometimes you’ll want to know when your custom fonts are
                    done loading. Perhaps you’ve done some rendering
                    calculations that are influenced by font metrics (like how
                    wide a line of text is) and thus need to recompute them when
                    your font is shown? The components above are great examples
                    of this.
                  </PreventWidows>
                </Justify>
                <Justify>
                  <PreventWidows>
                    The <code>FontObserver</code> component offers an interface
                    to this information. By supplying{" "}
                    <code>FontObserver.Provider</code> a list of fonts to
                    observe, it will use{" "}
                    <a
                ...
                <Justify>
                  <PreventWidows>
                    Below is a list of the fonts used on this page, rendered
                    using data from <code>FontObserver</code>. The symbol
                    rendered next to each font is based on the{" "}
                    <code>loaded</code> and <code>error</code> properties that
                    are populated for each font.
                  </PreventWidows>
                </Justify>
